/* 
    generate and store embeddings in SQL Server using stored procedures
    use this script file only if you prefer to generate and store embeddings in SQL Server using stored procedures
 */
USE [TestDB];
GO
...
DECLARE @EndpointBaseUrl nvarchar(4000) = N'https://<your azure openai name>.openai.azure.com/';
