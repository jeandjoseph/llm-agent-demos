...
-- Replace <your azure openai name>, <your deployment name>, and <API_VERSION> with your actual values.
-------------------------------------------------------------------------------
...
GO
SELECT AI_GENERATE_EMBEDDINGS('I love AI' USE MODEL MyAzureOpenAIModel) AS embedding
