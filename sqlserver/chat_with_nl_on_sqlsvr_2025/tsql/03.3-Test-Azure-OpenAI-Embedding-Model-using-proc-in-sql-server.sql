/*
  use this script to test the Azure OpenAI embeddings model
  only if preferred using stored procedures to generate embeddings
  make sure to replace the placeholders with your actual Azure OpenAI details.
  make sure you have created the credential for the Azure OpenAI service.
*/
